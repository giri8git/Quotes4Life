...
export default class LifeQuote extends Component {
  state = {
    result: 'loading',
    loading: false,
    staytune: false,
  ...
  GetQuotes() {
    ...
    fetch('https://surendragiri.com/quotes4life/life/love/read.php', {
      method: 'GET',
      headers: {
            ...
            renderItem={({item}) => (
              <View style={{flex: 1, flexDirection: 'row'}}>
                <TouchableOpacity
                  ...
                  onPressIn={() =>
                    this.setState({
                      image_URL: `https://surendragiri.com/quotes4life/life/uploads/${item.image}`,
                    })
                  }>
                  <Image
                    source={{
                      uri: `https://surendragiri.com/quotes4life/life/uploads/${item.image}`,
                    }}
                    style={{
                      width: 300,
                      height: 300,
